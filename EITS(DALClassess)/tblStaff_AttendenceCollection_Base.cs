// <fileinfo name="tblStaff_AttendenceCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="tblStaff_AttendenceCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="tblStaff_AttendenceCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class tblStaff_AttendenceCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="tblStaff_AttendenceCollection_Base"/> 
		/// class with the specified <see cref="EITSDB"/>.
		/// </summary>
		/// <param name="db">The <see cref="EITSDB"/> object.</param>
		public tblStaff_AttendenceCollection_Base(EITSDB db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>tblStaff_Attendence</c> table.
		/// </summary>
		/// <returns>An array of <see cref="tblStaff_AttendenceRow"/> objects.</returns>
		public virtual tblStaff_AttendenceRow[] GetAll()
		{
		...
		/// includes all records from the <c>tblStaff_Attendence</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>tblStaff_Attendence</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateGetAllCommand()
		{
			return _db.CreateCommand("dbo._tblStaff_Attendence_GetAll", true);
		}

		/// <summary>
		/// Gets the first <see cref="tblStaff_AttendenceRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="tblStaff_AttendenceRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public tblStaff_AttendenceRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			tblStaff_AttendenceRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="tblStaff_AttendenceRow"/> objects that 
		...
		/// <returns>An array of <see cref="tblStaff_AttendenceRow"/> objects.</returns>
		public tblStaff_AttendenceRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="tblStaff_AttendenceRow"/> objects.</returns>
		public virtual tblStaff_AttendenceRow[] GetAsArray(string whereSql, string orderBySql,
		...
		{
			string sql = "SELECT * FROM [dbo].[tblStaff_Attendence]";
		...
		/// <summary>
		/// Gets <see cref="tblStaff_AttendenceRow"/> by the primary key.
		/// </summary>
		/// <param name="atten_ID">The <c>Atten_ID</c> column value.</param>
		/// <returns>An instance of <see cref="tblStaff_AttendenceRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual tblStaff_AttendenceRow GetByPrimaryKey(long atten_ID)
		{
			IDbCommand cmd = _db.CreateCommand("dbo._tblStaff_Attendence_GetByPrimaryKey", true);
			AddParameter(cmd, "Atten_ID", atten_ID);
			tblStaff_AttendenceRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="tblStaff_AttendenceRow"/> objects 
		...
		/// <returns>An array of <see cref="tblStaff_AttendenceRow"/> objects.</returns>
		public tblStaff_AttendenceRow[] GetByContract_ID(int contract_ID)
		{
		...
		/// <returns>An array of <see cref="tblStaff_AttendenceRow"/> objects.</returns>
		public virtual tblStaff_AttendenceRow[] GetByContract_ID(int contract_ID, bool contract_IDNull)
		{
		...
		{
			IDbCommand cmd = _db.CreateCommand("dbo._tblStaff_Attendence_GetBy_Contract_ID", true);
			AddParameter(cmd, "Contract_ID", contract_IDNull ? null : (object)contract_ID);
			return cmd;
		}

		/// <summary>
		/// Adds a new record into the <c>tblStaff_Attendence</c> table.
		/// </summary>
		/// <param name="value">The <see cref="tblStaff_AttendenceRow"/> object to be inserted.</param>
		public virtual void Insert(tblStaff_AttendenceRow value)
		{
			IDbCommand cmd = _db.CreateCommand("dbo._tblStaff_Attendence_Insert", true);
		...
		/// <summary>
		/// Updates a record in the <c>tblStaff_Attendence</c> table.
		/// </summary>
		/// <param name="value">The <see cref="tblStaff_AttendenceRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(tblStaff_AttendenceRow value)
		{
			IDbCommand cmd = _db.CreateCommand("dbo._tblStaff_Attendence_Update", true);
			AddParameter(cmd, "Contract_ID",
				value.IsContract_IDNull ? DBNull.Value : (object)value.Contract_ID);
			AddParameter(cmd, "Atten_Date",
				value.IsAtten_DateNull ? DBNull.Value : (object)value.Atten_Date);
		...
		/// <summary>
		/// Updates the <c>tblStaff_Attendence</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>tblStaff_Attendence</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>tblStaff_Attendence</c> table.
		/// </summary>
		/// <param name="value">The <see cref="tblStaff_AttendenceRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(tblStaff_AttendenceRow value)
		{
			return DeleteByPrimaryKey(value.Atten_ID);
		}

		/// <summary>
		/// Deletes a record from the <c>tblStaff_Attendence</c> table using
		...
		{
			IDbCommand cmd = _db.CreateCommand("dbo._tblStaff_Attendence_DeleteByPrimaryKey", true);
			AddParameter(cmd, "Atten_ID", atten_ID);
			return 0 < cmd.ExecuteNonQuery();
		}

		/// <summary>
		/// Deletes records from the <c>tblStaff_Attendence</c> table using the 
		...
		{
			IDbCommand cmd = _db.CreateCommand("dbo._tblStaff_Attendence_DeleteBy_Contract_ID", true);
			AddParameter(cmd, "Contract_ID", contract_IDNull ? null : (object)contract_ID);
			return cmd;
		}

		/// <summary>
		/// Deletes <c>tblStaff_Attendence</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>tblStaff_Attendence</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		{
			string sql = "DELETE FROM [dbo].[tblStaff_Attendence]";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>tblStaff_Attendence</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		public int DeleteAll()
		{
			return _db.CreateCommand("dbo._tblStaff_Attendence_DeleteAll", true).ExecuteNonQuery();
		}
		...
		/// <returns>An array of <see cref="tblStaff_AttendenceRow"/> objects.</returns>
		protected tblStaff_AttendenceRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="tblStaff_AttendenceRow"/> objects.</returns>
		protected tblStaff_AttendenceRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="tblStaff_AttendenceRow"/> objects.</returns>
		protected virtual tblStaff_AttendenceRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					tblStaff_AttendenceRow record = new tblStaff_AttendenceRow();
			...
			return (tblStaff_AttendenceRow[])(recordList.ToArray(typeof(tblStaff_AttendenceRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="tblStaff_AttendenceRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="tblStaff_AttendenceRow"/> object.</returns>
		protected virtual tblStaff_AttendenceRow MapRow(DataRow row)
		{
			tblStaff_AttendenceRow mappedObject = new tblStaff_AttendenceRow();
		...
		/// the <c>tblStaff_Attendence</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "tblStaff_Attendence";
			DataColumn dataColumn;
	...
	} // End of tblStaff_AttendenceCollection_Base class
}  // End of namespace
