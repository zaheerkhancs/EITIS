// <fileinfo name="aspnet_ApplicationsCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="aspnet_ApplicationsCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="aspnet_ApplicationsCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class aspnet_ApplicationsCollection_Base
	{
		// Constants
		public const string ApplicationNameColumnName = "ApplicationName";
		public const string LoweredApplicationNameColumnName = "LoweredApplicationName";
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="aspnet_ApplicationsCollection_Base"/> 
		/// class with the specified <see cref="EITSDB"/>.
		/// </summary>
		/// <param name="db">The <see cref="EITSDB"/> object.</param>
		public aspnet_ApplicationsCollection_Base(EITSDB db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>aspnet_Applications</c> table.
		/// </summary>
		/// <returns>An array of <see cref="aspnet_ApplicationsRow"/> objects.</returns>
		public virtual aspnet_ApplicationsRow[] GetAll()
		{
		...
		/// includes all records from the <c>aspnet_Applications</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="aspnet_ApplicationsRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="aspnet_ApplicationsRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public aspnet_ApplicationsRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			aspnet_ApplicationsRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="aspnet_ApplicationsRow"/> objects that 
		...
		/// <returns>An array of <see cref="aspnet_ApplicationsRow"/> objects.</returns>
		public aspnet_ApplicationsRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="aspnet_ApplicationsRow"/> objects.</returns>
		public virtual aspnet_ApplicationsRow[] GetAsArray(string whereSql, string orderBySql,
		...
		{
			string sql = "SELECT * FROM [dbo].[aspnet_Applications]";
		...
		/// <summary>
		/// Gets <see cref="aspnet_ApplicationsRow"/> by the primary key.
		/// </summary>
		/// <param name="applicationId">The <c>ApplicationId</c> column value.</param>
		/// <returns>An instance of <see cref="aspnet_ApplicationsRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual aspnet_ApplicationsRow GetByPrimaryKey(System.Guid applicationId)
		{
			IDbCommand cmd = _db.CreateCommand("dbo._aspnet_Applications_GetByPrimaryKey", true);
			AddParameter(cmd, "ApplicationId", applicationId);
			aspnet_ApplicationsRow[] tempArray = MapRecords(cmd);
		...
		/// <summary>
		/// Updates the <c>aspnet_Applications</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>aspnet_Applications</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((System.Guid)row["ApplicationId"]);
						}
						finally
						{
							row.Delete();
		...
		/// <summary>
		/// Deletes a record from the <c>aspnet_Applications</c> table using
		/// the specified primary key.
		/// </summary>
		/// <param name="applicationId">The <c>ApplicationId</c> column value.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public virtual bool DeleteByPrimaryKey(System.Guid applicationId)
		{
			IDbCommand cmd = _db.CreateCommand("dbo._aspnet_Applications_DeleteByPrimaryKey", true);
			AddParameter(cmd, "ApplicationId", applicationId);
			return 0 < cmd.ExecuteNonQuery();
		}

		/// <summary>
		/// Deletes <c>aspnet_Applications</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>aspnet_Applications</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		{
			string sql = "DELETE FROM [dbo].[aspnet_Applications]";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>aspnet_Applications</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		public int DeleteAll()
		{
			return _db.CreateCommand("dbo._aspnet_Applications_DeleteAll", true).ExecuteNonQuery();
		}
		...
		/// <returns>An array of <see cref="aspnet_ApplicationsRow"/> objects.</returns>
		protected aspnet_ApplicationsRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="aspnet_ApplicationsRow"/> objects.</returns>
		protected aspnet_ApplicationsRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// the <c>aspnet_Applications</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "aspnet_Applications";
			DataColumn dataColumn;
			dataColumn = dataTable.Columns.Add("ApplicationName", typeof(string));
			dataColumn.MaxLength = 256;
			dataColumn.AllowDBNull = false;
			dataColumn = dataTable.Columns.Add("LoweredApplicationName", typeof(string));
			dataColumn.MaxLength = 256;
			dataColumn.AllowDBNull = false;
	...
	} // End of aspnet_ApplicationsCollection_Base class
}  // End of namespace
