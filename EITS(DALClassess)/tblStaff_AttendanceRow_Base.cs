// <fileinfo name="tblStaff_AttendanceRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="tblStaff_AttendanceRow"/> that 
	/// represents a record in the <c>tblStaff_Attendance</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="tblStaff_AttendanceRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class tblStaff_AttendanceRow_Base
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="tblStaff_AttendanceRow_Base"/> class.
		/// </summary>
		public tblStaff_AttendanceRow_Base()
		{
			// EMPTY
		}
	...
	} // End of tblStaff_AttendanceRow_Base class
} // End of namespace
