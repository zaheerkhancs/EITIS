<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile ="~/MasterPages/MainPage.Master" CodeBehind="VisaType.aspx.cs" Inherits="EITS_App.lkpVisaType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Button ID="btnHidden" runat="Server" Style="display: none" />
        <cc1:ModalPopupExtender ID="mpePanel" runat="server" TargetControlID="btnHidden" PopupControlID="pnlPopup" CancelControlID="imgCancel" BackgroundCssClass="modalBackground" PopupDragHandleControlID="Caption" Drag="true">
                ...
                <td class="style2">
                    <asp:Panel ID="pnlPopup" runat="server" CssClass="modalBox" Style="display: none;" Width="500px">
				      <asp:Panel ID="pnlManage" runat="server" CssClass="caption" Style="margin-bottom: 10px; cursor: hand;">
                          Visa Types</asp:Panel>
				<asp:HiddenField ID="hidEditIndex" runat="server" Value="-1" />
				<div class="divCol">
					Visa Type ID:</div>
				<div class="divColLast">
					<asp:TextBox ID="txtVisaType_ID" runat="server" MaxLength="64" Width="250" 
    ...
    <div class="divCol">
					Visa Type Name:</div>
				<div class="divColLast">
					<asp:TextBox ID="txtVisa_TypeName" runat="server" MaxLength="64" Width="250" ></asp:TextBox>
					<asp:RequiredFieldValidator ID="rfv" runat="server" ErrorMessage="" Text='<img src="../images/Message_Warning.png">' ControlToValidate="txtVisa_TypeName"></asp:RequiredFieldValidator>
				</div>
				<div class="clearer">
				</div>
				<div class="divCol">
            ...
            <td colspan="3">
               <asp:GridView ID="_gvList" runat="server" AutoGenerateColumns="False" Font-Names="Tahoma" 
                    ...
                    style="font-size: small; font-family: Verdana">
                        <Columns>
                            <asp:BoundField DataField="VisaType_ID" HeaderText="Visa Type ID" 
                                ItemStyle-Width="180px">
                                <ItemStyle Width="180px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="VisaType_Name" HeaderText="Visa Type Name" 
                            ...
                            <asp:TemplateField ItemStyle-Width="10px">
                                <ItemTemplate>
                                    <asp:ImageButton ID="imgEdit" runat="server" CausesValidation="False" 
                                        CommandArgument='<%# Eval("VisaType_ID") %>' ImageUrl="~/images/edt.gif" 
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:ImageButton ID="imgDelete" runat="server" 
                                        CommandArgument='<%# Eval("VisaType_ID") %>' 
                                        ImageUrl="~/images/del.gif" oncommand="imgDelete_Command" 
