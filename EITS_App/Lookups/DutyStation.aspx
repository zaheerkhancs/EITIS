<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MainPage.Master"
    CodeBehind="DutyStation.aspx.cs" Inherits="EITS_App.Lookups.lkpdutystation" %>
                    ...
                    <td class="style2">
                        <asp:Panel ID="pnlPopup" runat="server" CssClass="modalBox" Style="display :none;" Width="500px">
                            <asp:Panel ID="pnlManage" runat="server" CssClass="caption" Style="margin-bottom: 10px;
                                cursor: hand;">
                                Duty Station</asp:Panel>
                            <asp:HiddenField ID="hidEditIndex" runat="server" Value="-1" />
                            <div class="divCol">
                                Duty Station ID:</div>
                            <div class="divColLast">
                                <asp:TextBox ID="txtDutyStation_ID" runat="server" MaxLength="64" Width="250" Enabled="False"
                            ...
                            <div class="divColLast">
                                <asp:TextBox ID="txtDutyStationName" runat="server" MaxLength="64" Width="250"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage=""
                                    Text='<img src="../images/Message_Warning.png">' ControlToValidate="txtDutyStationName"></asp:RequiredFieldValidator>
                            </div>
                            <div class="clearer">
                            </div>
                            <div class="clearer">
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="_gvList" runat="server" AutoGenerateColumns="False" Font-Names="Tahoma"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="DutyStation_ID" HeaderText="Duty Station ID" 
                                                ItemStyle-Width="300px">
                                                <ItemStyle Width="300px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="DutyStation_Name" HeaderText="Duty Station" 
                                            ...
                                            <asp:TemplateField ItemStyle-Width="10px">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="imgEdit" runat="server" CausesValidation="False" ImageUrl="~/images/edt.gif"
                                                        CommandArgument='<%# Eval("DutyStation_ID") %>' 
