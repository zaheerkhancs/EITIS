<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MainPage.Master" CodeBehind="Agency.aspx.cs" Inherits="EITS_App.Lookups.Agency" %>
                    ...
                    <td class="style2">
                        <asp:Panel ID="pnlPopup" runat="server" CssClass="modalBox" Style="display:none ;" Width="500px">
                            <asp:Panel ID="pnlManage" runat="server" CssClass="caption" Style="margin-bottom: 10px;
                                cursor: hand;">
                                Agency Record</asp:Panel>
                            <asp:HiddenField ID="hidEditIndex" runat="server" Value="-1" />
                            <div class="divCol">
                                Agency_ID:</div>
                            <div class="divColLast">
                                <asp:TextBox ID="txtAgencyID" runat="server" MaxLength="64" Width="250" 
                            ...
                            <div class="divColLast">
                                <asp:TextBox ID="txtAgencyName" runat="server" MaxLength="64" Width="250" ></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rq1" runat="server" ErrorMessage="" Text ='<img src="../images/Message_Warning.png">' ControlToValidate ="txtAgencyName"></asp:RequiredFieldValidator> 
                             </div>
                            <div class="clearer">
                            </div>
                            <div class="clearer">
                                            ...
                                            <asp:TemplateField ItemStyle-Width="10px">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="imgEdit" runat="server" CausesValidation="False" ImageUrl="~/images/edt.gif"
                                                        CommandArgument='<%# Eval("Agency_ID") %>' 
