<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MainPage.Master"
    CodeBehind="ContractTypes.aspx.cs" Inherits="EITS_App.ContractTypes" %>
                    ...
                    <td class="style2">
                        <asp:Panel ID="pnlPopup" runat="server" CssClass="modalBox" Style="display: none;"
                            ...
                            <asp:Panel ID="pnlManage" runat="server" CssClass="caption" Style="margin-bottom: 10px;
                                cursor: hand;">
                                Contract Types</asp:Panel>
                            <asp:HiddenField ID="hidEditIndex" runat="server" Value="-1" />
                            <div class="divCol">
                                Contract Type ID:</div>
                            <div class="divColLast">
                                <asp:TextBox ID="txtCon_ID" runat="server" MaxLength="64" Width="250" Enabled="False"></asp:TextBox>
                            </div>
                            <div class="clearer">
                            </div>
                            <div class="divCol">
                                Contract Type Name:</div>
                            <div class="divColLast">
                                <asp:TextBox ID="txtCon_TypeName" runat="server" MaxLength="64" Width="250"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfv" runat="server" ErrorMessage="" Text='<img src="../images/Message_Warning.png">' ControlToValidate="txtCon_TypeName"></asp:RequiredFieldValidator>
                            </div>
                            <div class="clearer">
                            </div>
                            <div class="divCol">
                            ...
                            <tr>
                                <td colspan="3">
                                    <asp:GridView ID="_gvList" runat="server" AutoGenerateColumns="False" Font-Names="Tahoma"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="ContractType_ID" HeaderText="Contract ID" ItemStyle-Width="180px">
                                                <ItemStyle Width="180px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Type_Name" HeaderText="Contract Type Name" ItemStyle-Width="300px">
                                                <ItemStyle Width="300px" />
                                            </asp:BoundField>
                                            <asp:CheckBoxField DataField="Active" HeaderText="Active" Visible="False" />
                                            <asp:TemplateField ItemStyle-Width="10px">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="imgEdit" runat="server" CausesValidation="False" CommandArgument='<%# Eval("ContractType_ID") %>'
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="imgDelete" runat="server" CommandArgument='<%# Eval("ContractType_ID") %>'
